...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Yᴏᴜ Hᴀᴠᴇ Nᴏᴛ Pᴜʀᴄʜᴀsᴇᴅ Yᴇᴛ Pᴜʀᴄʜᴀsᴇ Nᴏᴡ:- @REVENGEKING199."
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @REVENGEKING199 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Fʀᴇᴇ Kᴇ Dʜᴀʀᴍ Sʜᴀʟᴀ Hᴀɪ Yᴀ Jᴏ Mᴜ Uᴛᴛʜᴀ Kᴀɪ Kʜɪ Bʜɪ Gᴜꜱ Rʜᴀɪ Hᴏ Bᴜʏ Kʀᴏ Fʀᴇᴇ Mᴀɪ Kᴜᴄʜ Nʜɪ Mɪʟᴛᴀ Bᴜʏ:- @REVENGEKING199 🙇."
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @REVENGEKING199"
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "Yᴏᴜ Aʀᴇ Oɴ Cᴏᴏʟᴅᴏᴡɴ ❌. Pʟᴇᴀsᴇ Wᴀɪᴛ 10sᴇᴄ Bᴇғᴏʀᴇ Rᴜɴɴɪɴɢ Tʜᴇ  /bgmi Cᴏᴍᴍᴀɴᴅ Aɢᴀɪɴ."
                bot.reply_to(message, response)
                return
